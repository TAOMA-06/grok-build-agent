          ...
          <Tabs.Root className="gb-settings-tabs" value={tab} onValueChange={(value) => setTab(value as SettingsTab)}>
            ...
            <div className="gb-settings-content">
              ...
              <Tabs.Content value="agent">
                ...
                <label><span>{t.privacyShield}<small>{t.privacyShieldHint}</small></span><select value={draft.privacyMode} onChange={(event) => patch({ privacyMode: event.target.value as Settings["privacyMode"] })}><option value="strict">{t.privacyStrict}</option><option value="standard">{t.privacyStandard}</option></select></label>
